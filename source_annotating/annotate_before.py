...
annotate with before enrichment, (no locaiton info in the log)
...
def annotate_before(path_to_log,eventlog,sentiment_file ):
    ...
    for log_row in logreader:
        ...
        if not log_row[log_case_id_ind] in case_ids_set:
            ...
            if log_date in sentiment_dict:
                ...
                if not (try_to_find_date_in_the_window_of_time(log_date,log_row,sentiment_dict,writer)):
            ...
            if prev_date < log_date:
                ...
                if normalize_coefficient != 0:
                    ...
                    print("mormcoef" + str(normalize_coefficient))
                else:
                    writer.writerow(log_row + [0, 0])
